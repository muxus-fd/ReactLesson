    ...
    //   };
        ...
        render(){
            return <>
                    ...
                    messageField={() => <MessageList chatId={ this.props.chatId } sendMessages={this.props.sendMessages}/>}
...
const mapStateToProps = (state) => ({
 ...
 const mapDispatchToProps = dispatch => bindActionCreators({ sendMessages,loadChats }, dispatch);
